...
<body>
	...
	<jsp:useBean id="sel" class="com.inhatc.BillyU.ProductDAO"></jsp:useBean>
	<%
	...
	%>
<%-- 	<jsp:useBean id="se" class="com.inhatc.BillyU.ProductDAO"></jsp:useBean>
	<%
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-7">
				<img class="img-responsive" src="/BillyU/resource/img/1.jpg" alt="Chania" width="600"
					height="400">
			</div>
			<div class="col-lg-4">
